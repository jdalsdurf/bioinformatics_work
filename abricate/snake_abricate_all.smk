...
file_list = []
### location assumes that data is in abricate_in/ folder which is output of SPADES snake workflow
for entry in os.scandir("abricate_in/"):
    if entry.is_file():
        file_list.append(entry.name)
#### this tells where data is that will be used for dictionary
config_dict = {"samples":{i.split(".")[0]:"abricate_in/"+i for i in file_list}}
