...
rule kraken2:
    ...
    #     "kraken2_env.yaml"
    shell:
        "kraken2 --use-names --db /media/nfs/bioinformatics/databases/kraken2/ --threads 60 --memory-mapping --quick --classified-out {output.cl} --report {output.r} {input} > {output.k}"
###
